...
/**
 * The State for quitting the game. Asks the user if they would like to quit the game or return to the main menu.
 */
public class QuitState implements State {
    ...
    /**
     * @return The MainMenuInputValidator of this QuitState.
     */
    @Override
