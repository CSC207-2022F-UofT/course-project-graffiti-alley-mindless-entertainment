...
public class MainMenuInputValidator implements InputValidator {
    ...
    public String parseAndValidate(String input) {
        ...
        if (this.currOption == MainMenuOptions.MAINMENU) {
            ...
            else if (input.equalsIgnoreCase(MainMenuOptions.LOAD.toString())) {
                return input.toLowerCase();
            }
            else if (input.equalsIgnoreCase(MainMenuOptions.QUIT.toString())) {
                return input.toLowerCase();
            }
            else {
                return null;
            ...
            else if (input.equalsIgnoreCase(MainMenuOptions.SAVE2.toString())) {
                return input.toLowerCase();
            }
            else if (input.equalsIgnoreCase(MainMenuOptions.SAVE3.toString())) {
                return input.toLowerCase();
            }
            else if (input.equalsIgnoreCase(MainMenuOptions.RETURN.toString())) {
                return input.toLowerCase();
            }
            else {
                return null;
